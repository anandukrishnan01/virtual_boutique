...
class CMate:
    ...
    def cloth_segmentation(self):
        ...
        try:
            print("rasing: : :errorss : ", self.source_img)
            print("rasing: : :errors : ", self.dest_pose_estimator)

            print("Calling cloth_extractor.extract_cloth...")
            source_img, source_seg = cloth_extractor.extract_cloth(self.source_img)
            print("cloth_extractor.extract_cloth returned.")
